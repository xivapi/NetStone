...
namespace NetStone.Model.Parseables
{
    ...
    public class GearEntry : LodestoneParseable, IOptionalParseable<GearEntry>
    {
        ...
        /// </summary>
        public Uri ItemDatabaseLink => ParseHref(this.definition.DbLink.Selector);
        ...
        /// </summary>
        public Uri GlamourDatabaseLink => ParseHref(this.definition.MirageDbLink.Selector);

        /// <summary>
        /// Name of the glamoured item.
        /// </summary>
        public string GlamourName => ParseInnerText(this.definition.MirageName.Selector);

        /// <summary>
        /// Name of the dye applied to this item.
        /// </summary>
        //TODO: parse
        public string Stain => ParseInnerText(this.definition.Stain.Selector);
        ...
        {
            ParseInnerText(this.definition.Materia1.Selector),
            ParseInnerText(this.definition.Materia2.Selector),
            ParseInnerText(this.definition.Materia3.Selector),
            ParseInnerText(this.definition.Materia4.Selector),
            ParseInnerText(this.definition.Materia5.Selector),
        };

        /// <summary>
        /// Name of this item's crafter.
        /// </summary>
        public string CreatorName => ParseInnerText(this.definition.CreatorName.Selector);
